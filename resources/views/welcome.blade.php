...
<link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css" rel="stylesheet">
        ...
        <div class="bg-white rounded-lg shadow-md p-4 mb-6">
            <div class="flex justify-between items-center">
                ...
                <div class="flex space-x-4">
                    <button onclick="showSalesHistory()" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg">
                ...
                <div class="bg-white rounded-lg shadow-md p-4">
                    ...
                    <div class="mb-4">
                        <div class="flex flex-wrap gap-2" id="categoryFilters">
                            <button onclick="filterByCategory('all')" class="category-btn active bg-blue-500 text-white px-3 py-1 rounded-full text-sm">All</button>
                        </div>
                    </div>

                    <!-- Products Grid -->
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-h-96 overflow-y-auto" id="productsGrid">
    ...
    <div id="receiptModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50">
        <div class="flex items-center justify-center min-h-screen p-4">
            <div class="bg-white rounded-lg max-w-md w-full">
                ...
                <div class="p-4">
                    <div class="receipt-preview bg-gray-50 p-4 rounded border max-h-96 overflow-y-auto" id="receiptContent">
                        <!-- Receipt content will be generated here -->
                    </div>
                    <div class="mt-4 flex space-x-2">
                        <button onclick="printReceipt()" class="flex-1 bg-blue-500 hover:bg-blue-600 text-white py-2 rounded">
                            <i class="fas fa-print mr-2"></i>Print
                        </button>
                        <button onclick="closeReceiptModal()" class="flex-1 bg-gray-500 hover:bg-gray-600 text-white py-2 rounded">
                            Close
                        </button>
                    </div>
                </div>
    ...
    <!-- Sales History Modal -->
    <div id="salesModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50">
        <div class="flex items-center justify-center min-h-screen p-4">
            <div class="bg-white rounded-lg max-w-4xl w-full max-h-96">
                <div class="p-4 border-b">
                    <div class="flex justify-between items-center">
                        <h3 class="text-lg font-semibold">Sales History</h3>
                        <button onclick="closeSalesModal()" class="text-gray-500 hover:text-gray-700">
                            <i class="fas fa-times"></i>
                        </button>
                    </div>
                </div>
                <div class="p-4 max-h-80 overflow-y-auto" id="salesHistory">
    ...
    <script>
        ...
        function renderCategoryFilters() {
            ...
            categories.forEach(category => {
                ...
                button.className = `category-btn px-3 py-1 rounded-full text-sm mr-2 mb-2 ${category === 'all' ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-700'}`;
        ...
        function filterByCategory(category) {
            ...
            event.target.className = event.target.className.replace('bg-gray-200 text-gray-700', 'bg-blue-500 text-white');
        ...
        function displayProducts(productsToShow) {
            ...
            productsToShow.forEach(product => {
                ...
                productCard.innerHTML = `
                    ...
                    <div class="text-xs text-blue-600 truncate">${product.brands || ''}</div>
                    <div class="mt-2 flex justify-between items-center">
                        <span class="text-green-600 font-bold">Rs. ${Number(product.selling_price).toLocaleString()}</span>
                ...
                cart.forEach((item, index) => {
                    ...
                    cartItem.innerHTML = `
                        <div class="flex-1">
                            ...
                            <div class="text-sm text-green-600">Rs. ${Number(item.price).toLocaleString()}</div>
                        </div>
                        <div class="flex items-center space-x-2">
                            <button onclick="updateQuantity(${index}, -1)" class="bg-red-500 text-white w-6 h-6 rounded-full text-xs">-</button>
                            <span class="w-8 text-center">${item.quantity}</span>
                            <button onclick="updateQuantity(${index}, 1)" class="bg-green-500 text-white w-6 h-6 rounded-full text-xs">+</button>
        ...
        function updateTotals() {
            ...
            const tax = Math.max(0, discountedSubtotal * 0.16);
        ...
        function generateReceiptPreview(sale) {
            ...
            receipt += rightAlign(`Tax (16%): ${Math.round(sale.tax_amount)}`, width) + "\n";
            receipt += "=".repeat(width) + "\n";
        ...
        async function showSalesHistory() {
            try {
                ...
                if (result.success) {
                    renderSalesHistory(result.data.data);
